...
def args_config():
    ...
    parser.add_argument('--model_name', type=str, default='Essnet_test2.t7', help='the model name')  # [**]
    parser.add_argument('--model_log', type=str, default='Essnet_test2', help='the model log file for check')  # [**]
    ...
    # loss
    parser.add_argument('--loss_mse_only', type=bool, default=True, help='Only use Mse as the loss')
