...
if __name__ == '__main__':
    ...
    for i, mask_indx in enumerate(mask_perc):
        mask.append(get_mask(mask_name[0], mask_indx, mask_path="../data/mask", verbose=0))
    # data
    img = cv2.imread(os.path.join("../data/17782", r"17782_" + "%05d.tif" % 1), cv2.IMREAD_GRAYSCALE)
