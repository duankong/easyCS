...
def args_config():
    ...
    # model
    parser.add_argument('--model', type=str, default='Unet_conv', help='the model name：Unet nestedUnet Unet_res Unet_conv')  # [**]
    ...
    parser.add_argument('--model_save', type=int, default='0', help='the model is save or not')
